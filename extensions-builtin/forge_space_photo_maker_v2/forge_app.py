...
def get_example():
    case = [
        [
            get_image_path_list(spaces.convert_root_path() + 'examples/scarletthead_woman'),
        ...
        [
            get_image_path_list(spaces.convert_root_path() + 'examples/newton_man'),
